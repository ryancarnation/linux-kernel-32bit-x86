...
gldelf_i386_after_open (void)
{
  ldelf_after_open (true, false,
		    false, false, 32, "/home/rcarnation/opt/cross");
}
...
OUTPUT_ARCH(i386)\n\
ENTRY(_start)\n\
SEARCH_DIR(\"=/home/rcarnation/opt/cross/i686-elf/lib\"); SEARCH_DIR(\"=/usr/local/lib\"); SEARCH_DIR(\"=/lib\"); SEARCH_DIR(\"=/usr/lib\");\n\
SECTIONS\n\
{\n\
...
"/* Script for -pie -z combreloc -z separate-code -z relro -z now --rosegment */\n\
/* Copyright (C) 2014-2025 Free Software Foundation, Inc.\n\
   Copying and distribution of this script, with or without modification,\n\
   are permitted in any medium without royalty provided the copyright\n\
   notice and this notice are preserved.  */\n\
...
"/* Script for -pie -z combreloc -z separate-code --rosegment */\n\
/* Copyright (C) 2014-2025 Free Software Foundation, Inc.\n\
   Copying and distribution of this script, with or without modification,\n\
   are permitted in any medium without royalty provided the copyright\n\
   notice and this notice are preserved.  */\n\
...
"/* Script for -pie -z separate-code --rosegment */\n\
/* Copyright (C) 2014-2025 Free Software Foundation, Inc.\n\
   Copying and distribution of this script, with or without modification,\n\
   are permitted in any medium without royalty provided the copyright\n\
   notice and this notice are preserved.  */\n\
...
"  .gnu_extab      : ONLY_IF_RW { *(.gnu_extab) }\n\
  ...
  ; else if (bfd_link_dll (&link_info)
             ...
             && link_info.one_rosegment
             && (link_info.flags & DF_BIND_NOW)) return
"/* Script for -shared -z combreloc -z separate-code -z relro -z now --rosegment */\n\
/* Copyright (C) 2014-2025 Free Software Foundation, Inc.\n\
   Copying and distribution of this script, with or without modification,\n\
   are permitted in any medium without royalty provided the copyright\n\
   notice and this notice are preserved.  */\n\
...
"  .sframe         : ONLY_IF_RW { *(.sframe) *(.sframe.*) }\n\
  ...
  ; else if (bfd_link_dll (&link_info)
             ...
             && link_info.one_rosegment
             && link_info.separate_code) return
"/* Script for -shared -z combreloc -z separate-code --rosegment */\n\
/* Copyright (C) 2014-2025 Free Software Foundation, Inc.\n\
   Copying and distribution of this script, with or without modification,\n\
   are permitted in any medium without royalty provided the copyright\n\
   notice and this notice are preserved.  */\n\
...
"  .sframe         : ONLY_IF_RW { *(.sframe) *(.sframe.*) }\n\
  ...
  ; else if (bfd_link_dll (&link_info)
             && link_info.one_rosegment
             && link_info.separate_code) return
"/* Script for -shared -z separate-code --rosegment */\n\
/* Copyright (C) 2014-2025 Free Software Foundation, Inc.\n\
   Copying and distribution of this script, with or without modification,\n\
   are permitted in any medium without royalty provided the copyright\n\
   notice and this notice are preserved.  */\n\
