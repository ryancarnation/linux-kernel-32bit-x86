  ...
  if (bfd_link_relocatable (&link_info) && config.build_constructors)
      ...
      if (link_info.separate_code)
	{
	  if (link_info.one_rosegment)
	    return "ldscripts/elf_iamcu.xdwer";
	  else
	...
	{
	  if (link_info.one_rosegment)
	    return "ldscripts/elf_iamcu.xdcer";
	  else
	...
	{
	  if (link_info.one_rosegment)
	    return "ldscripts/elf_iamcu.xder";
	  else
	...
	{
	  if (link_info.one_rosegment)
	    return "ldscripts/elf_iamcu.xswer";
	  else
	...
	{
	  if (link_info.one_rosegment)
	    return "ldscripts/elf_iamcu.xscer";
	  else
	...
	{
	  if (link_info.one_rosegment)
	    return "ldscripts/elf_iamcu.xser";
	  else
	...
	{
	  if (link_info.one_rosegment)
	    return "ldscripts/elf_iamcu.xwer";
	  else
	...
	{
	  if (link_info.one_rosegment)
	    return "ldscripts/elf_iamcu.xcer";
	  else
	...
	{
	  if (link_info.one_rosegment)
	    return "ldscripts/elf_iamcu.xer";
	  else
