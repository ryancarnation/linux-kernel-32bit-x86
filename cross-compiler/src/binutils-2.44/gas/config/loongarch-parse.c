...
#line 381 "config/loongarch-parse.c"
...
#line 463 "config/loongarch-parse.c"
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_shift_expression = 34,          /* shift_expression  */
...
{
       0,   343,   343,   344,   345,   346,   347,   351,   352,   353,
     357,   358,   359,   360,   361,   365,   366,   367,   368,   372,
     373,   374,   378,   379,   380,   384,   385,   386,   387,   388,
     392,   393,   394,   398,   399,   403,   404,   408,   409,   413,
     414,   418,   419,   423,   424,   428
};
#endif
...
static const char *const yytname[] =
{
  ...
  "multiplicative_expression", "shift_expression", "additive_expression",
...
static const yytype_int8 yypact[] =
{
     ...
     -28,     9,    34,    25,     0,    36,    -8,     7,    23,    32,
       1,   -28,    52,    22,    45,   -28,   -28,   -28,   -28,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,   -28,   -28,
      44,   -28,   -28,   -28,     9,     9,    34,    34,    25,    25,
      25,    25,     0,     0,    36,    -8,     7,    23,    32,    29,
...
static const yytype_int8 yytable[] =
{
      ...
      31,    76,    43,    77,    78,    79,    49,    77,    78,    32,
      33,    34,    35,    45,    69,    40,    41,    70,    71,    44,
      54,    55,    48,    56,    57,    62,    63,    72,    50,    80,
      81,    74,    64,    75,     0,     0,     0,    65,     0,     0,
      66,     0,    67,     0,    68
};
...
static const yytype_int8 yycheck[] =
{
      ...
      21,    14,    25,    16,    17,    14,    14,    16,    17,     5,
       6,    16,    17,    11,    47,     9,    10,     3,     4,    26,
      32,    33,     0,    34,    35,    40,    41,    28,    13,     3,
       3,    71,    42,    72,    -1,    -1,    -1,    43,    -1,    -1,
      44,    -1,    45,    -1,    46
};
...
#line 1533 "config/loongarch-parse.c"
    break;
...
#line 346 "./config/loongarch-parse.y"
...
#line 393 "./config/loongarch-parse.y"
                                                          {emit_bin (EQ_OP);}
...
#line 399 "./config/loongarch-parse.y"
                                                 {emit_bin ('&');}
