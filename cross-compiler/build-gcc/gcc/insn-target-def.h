...
{
  return 
#line 25354 "../../src/gcc-14.2.0/gcc/config/i386/i386.md"
...
{
  return 
#line 25427 "../../src/gcc-14.2.0/gcc/config/i386/i386.md"
...
static rtx_insn *
target_gen_memory_blockage (void)
{
  return insnify (gen_memory_blockage ());
}

#undef TARGET_HAVE_MEMORY_BLOCKAGE
#define TARGET_HAVE_MEMORY_BLOCKAGE hook_bool_void_true
#undef TARGET_GEN_MEMORY_BLOCKAGE
#define TARGET_GEN_MEMORY_BLOCKAGE target_gen_memory_blockage
#undef TARGET_CODE_FOR_MEMORY_BLOCKAGE
#define TARGET_CODE_FOR_MEMORY_BLOCKAGE CODE_FOR_memory_blockage
...
{
  return 
#line 27050 "../../src/gcc-14.2.0/gcc/config/i386/i386.md"
...
static rtx_insn *
target_gen_restore_stack_nonlocal (rtx x0, rtx x1)
{
  return insnify (gen_restore_stack_nonlocal (x0, x1));
}

#undef TARGET_HAVE_RESTORE_STACK_NONLOCAL
#define TARGET_HAVE_RESTORE_STACK_NONLOCAL hook_bool_void_true
#undef TARGET_GEN_RESTORE_STACK_NONLOCAL
#define TARGET_GEN_RESTORE_STACK_NONLOCAL target_gen_restore_stack_nonlocal
#undef TARGET_CODE_FOR_RESTORE_STACK_NONLOCAL
#define TARGET_CODE_FOR_RESTORE_STACK_NONLOCAL CODE_FOR_restore_stack_nonlocal

static bool
target_have_return (void)
{
  return 
#line 19032 "../../src/gcc-14.2.0/gcc/config/i386/i386.md"
...
static rtx_insn *
target_gen_save_stack_nonlocal (rtx x0, rtx x1)
{
  return insnify (gen_save_stack_nonlocal (x0, x1));
}

#undef TARGET_HAVE_SAVE_STACK_NONLOCAL
#define TARGET_HAVE_SAVE_STACK_NONLOCAL hook_bool_void_true
#undef TARGET_GEN_SAVE_STACK_NONLOCAL
#define TARGET_GEN_SAVE_STACK_NONLOCAL target_gen_save_stack_nonlocal
#undef TARGET_CODE_FOR_SAVE_STACK_NONLOCAL
#define TARGET_CODE_FOR_SAVE_STACK_NONLOCAL CODE_FOR_save_stack_nonlocal
...
{
  return 
#line 19055 "../../src/gcc-14.2.0/gcc/config/i386/i386.md"
