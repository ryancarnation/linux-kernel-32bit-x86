...
#line 25 "../../src/gcc-14.2.0/gcc/common.md"
{
...
#line 23 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == REG) && (
#line 28 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == REG) && (
#line 33 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(GENERAL_REGNO_P (REGNO (op))))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}

bool
index_reg_operand (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
  return ((GET_CODE (op) == REG) && (
#line 38 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(INDEX_REGNO_P (REGNO (op))))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return (GET_CODE (op) == REG) ? ((
#line 43 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(GENERAL_REGNO_P (REGNO (op)))) && (
...
{
  return (GET_CODE (op) == REG) ? ((
#line 49 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(GENERAL_REGNO_P (REGNO (op)))) && (
...
{
  return ((GET_CODE (op) == REG) && (
#line 55 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
#line 61 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == REG) && (
#line 67 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == REG) && (
#line 72 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == REG) && (
#line 77 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(QI_REGNO_P (REGNO (op))))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return ((
#line 81 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(TARGET_64BIT)) && ((GET_CODE (op) == REG) && (!(
#line 83 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(QI_REGNO_P (REGNO (op))))))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return ((GET_CODE (op) == REG) && (
#line 88 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(REGNO (op) == AX_REG))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return (GET_CODE (op) == REG) && (
#line 93 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(REGNO (op) == FLAGS_REG));
}
...
{
  return ((GET_CODE (op) == REG) && (
#line 98 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(MASK_REGNO_P (REGNO (op))))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}

bool
int248_register_operand (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
  return (register_operand (op, mode)) && (((
#line 103 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(TARGET_64BIT)) && (
#line 104 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(GET_MODE (op) == DImode))) || ((
#line 105 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(GET_MODE (op) == SImode)) || (
#line 106 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(GET_MODE (op) == HImode))));
}
...
#line 111 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(TARGET_64BIT)) && (
#line 112 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(GET_MODE (op) == DImode))) || ((
#line 113 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(GET_MODE (op) == SImode)) || ((
#line 114 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(GET_MODE (op) == HImode)) || (
#line 115 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(GET_MODE (op) == QImode)))));
}
...
{
  return (
#line 120 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return ((
#line 128 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(SSE_FLOAT_MODE_P (mode) && TARGET_SSE_MATH)) && (!(
#line 129 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return ((
#line 136 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(SSE_FLOAT_MODE_P (mode) && TARGET_SSE_MATH)) && (!(
#line 137 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (
#line 143 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
#line 154 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
...
#line 176 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
...
#line 305 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  if (ix86_endbr_immediate_operand (op, VOIDmode))
    return false;
...
#line 399 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  switch (GET_CODE (op))
    {
    case CONST_INT:
...
#line 422 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  if (ix86_endbr_immediate_operand (op, VOIDmode))
    return false;
...
{
  return ((GET_CODE (op) == SYMBOL_REF) && ((!(
#line 450 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(TARGET_64BIT))) || ((
#line 451 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(ix86_cmodel == CM_SMALL)) || (
#line 452 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(ix86_cmodel == CM_KERNEL))))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return (
#line 456 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (
#line 464 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (
#line 473 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (
#line 480 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (
#line 487 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(TARGET_64BIT)) ? ((nonimmediate_operand (op, mode)) || ((x86_64_zext_immediate_operand (op, mode)) && (
#line 490 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (
#line 496 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (
#line 504 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (
#line 511 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
#line 521 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  if (!flag_pic)
    return false;
...
#line 549 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  switch (GET_CODE (op))
    {
    case SYMBOL_REF:
...
#line 593 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
...
static inline bool
local_func_symbolic_operand_1 (rtx op ATTRIBUTE_UNUSED, machine_mode mode ATTRIBUTE_UNUSED)
#line 628 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  if (GET_CODE (op) == CONST
      && GET_CODE (XEXP (op, 0)) == PLUS
      && CONST_INT_P (XEXP (XEXP (op, 0), 1)))
...
bool
local_func_symbolic_operand (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
  return (local_symbolic_operand (op, mode)) && (
(local_func_symbolic_operand_1 (op, mode)));
}
...
{
  return ((!(
#line 650 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(TARGET_VXWORKS_RTP))) || ((
#line 651 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(ix86_cmodel == CM_LARGE)) || (
#line 652 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == SYMBOL_REF) && (
#line 658 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == SYMBOL_REF) && (
#line 662 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
tls_address_pattern (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
  ...
  return (
#line 666 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
#line 671 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
...
#line 684 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  if (SUBREG_P (op))
    op = SUBREG_REG (op);
...
static inline bool
register_no_SP_operand_1 (rtx op ATTRIBUTE_UNUSED, machine_mode mode ATTRIBUTE_UNUSED)
#line 702 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  if (SUBREG_P (op))
    op = SUBREG_REG (op);
...
bool
register_no_SP_operand (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
  return (register_operand (op, mode)) && (
(register_no_SP_operand_1 (op, mode)));
}

bool
call_register_operand (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
  return (
#line 722 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(TARGET_64BIT)) ? (register_operand (op, mode)) : (register_no_SP_operand (op, mode));
}
...
{
  return (register_operand (op, mode)) || ((!(
#line 741 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(TARGET_INDIRECT_BRANCH_REGISTER))) && ((!(
#line 742 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(TARGET_X32))) && (memory_operand (op, mode))));
}

static inline bool
sibcall_memory_operand_1 (rtx op ATTRIBUTE_UNUSED, machine_mode mode ATTRIBUTE_UNUSED)
#line 752 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  op = XEXP (op, 0);
  if (CONSTANT_P (op))
    return true;
...
#line 774 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (
#line 779 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(constant_call_address_operand
		     (op, mode == VOIDmode ? mode : Pmode))) || ((call_register_operand (op, mode)) || ((!(
#line 782 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(TARGET_INDIRECT_BRANCH_REGISTER))) && (((!(
#line 783 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(TARGET_X32))) && (memory_operand (op, mode))) || ((
#line 785 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (
#line 790 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(constant_call_address_operand
		     (op, mode == VOIDmode ? mode : Pmode))) || ((register_no_elim_operand (op, mode)) || ((!(
#line 793 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(TARGET_INDIRECT_BRANCH_REGISTER))) && (((!(
#line 794 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(TARGET_X32))) && (sibcall_memory_operand (op, mode))) || ((
#line 796 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(TARGET_X32 && Pmode == DImode)) && (GOT_memory_operand (op, mode))))));
}
...
#line 803 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
#line 808 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  if (mode == VOIDmode)
    mode = GET_MODE (op);
...
#line 817 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  if (mode == VOIDmode)
    mode = GET_MODE (op);
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 826 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(op == constm1_rtx));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 831 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(INTVAL (op) == 8));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 836 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(INTVAL (op) == 128));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 841 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
#line 847 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
...
#line 855 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  HOST_WIDE_INT i = INTVAL (op);
  return i == 1 || i == 2 || i == 3;
}
...
#line 863 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  HOST_WIDE_INT i = INTVAL (op);
...
#line 871 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  HOST_WIDE_INT i = INTVAL (op);
...
#line 879 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  HOST_WIDE_INT i = INTVAL (op);
  return i == 3 || i == 5 || i == 9;
}
...
#line 887 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  HOST_WIDE_INT i = INTVAL (op);
  return i == 4 || (i >= 8 && i <= 11);
}
...
#line 895 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  HOST_WIDE_INT i = INTVAL (op);
  return i == 4 || i == 8;
}
...
{
  return (GET_CODE (op) == CONST_INT) && ((
#line 903 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(op == const0_rtx)) || (
#line 904 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(op == const1_rtx)));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 909 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 914 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 919 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 924 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 929 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 934 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 939 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 944 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
static inline bool
const_0_to_255_not_mul_8_operand_1 (rtx op ATTRIBUTE_UNUSED, machine_mode mode ATTRIBUTE_UNUSED)
#line 962 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  unsigned HOST_WIDE_INT val = INTVAL (op);
...
bool
const_0_to_255_not_mul_8_operand (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
  return (GET_CODE (op) == CONST_INT) && (
(const_0_to_255_not_mul_8_operand_1 (op, mode)));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 971 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 977 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 982 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 987 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 992 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 997 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 1002 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 1007 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 1012 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 1017 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 1022 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 1027 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 1032 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 1037 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 1042 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 1047 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 1052 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 1057 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(IN_RANGE (INTVAL (op), 28, 31)));
}

static inline bool
incdec_operand_1 (rtx op ATTRIBUTE_UNUSED, machine_mode mode ATTRIBUTE_UNUSED)
#line 1062 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
...
{
  return ((register_operand (op, mode)) && (
#line 1073 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return ((register_operand (op, mode)) && (
#line 1078 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return ((register_operand (op, mode)) && ((
#line 1083 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(TARGET_SSE4_1)) && (
#line 1084 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
#line 1091 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(op == const1_rtx)) || (
#line 1092 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(op == constm1_rtx)))) && (
(mode == VOIDmode || GET_MODE (op) == mode || GET_MODE (op) == VOIDmode)));
}
...
#line 1099 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (
#line 1103 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (
#line 1108 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
#line 1116 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  unsigned n_elts;
...
#line 1137 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  mode = GET_MODE (op);
...
#line 1184 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(INTEGRAL_MODE_P (GET_MODE (op)))) && (
#line 1185 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(op == CONSTM1_RTX (GET_MODE (op)))))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}

bool
int_float_vector_all_ones_operand (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
  return (vector_all_ones_operand (op, mode)) || ((float_vector_all_ones_operand (op, mode)) || ((
#line 1191 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(op == constm1_rtx)) && (
(mode == VOIDmode || GET_MODE (op) == mode || GET_MODE (op) == VOIDmode))));
}

static inline bool
vector_all_ones_zero_extend_half_operand_1 (rtx op ATTRIBUTE_UNUSED, machine_mode mode ATTRIBUTE_UNUSED)
#line 1197 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  mode = GET_MODE (op);
...
bool
vector_all_ones_zero_extend_half_operand (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
  return ((GET_CODE (op) == CONST_VECTOR) && (
(vector_all_ones_zero_extend_half_operand_1 (op, mode)))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}

static inline bool
vector_all_ones_zero_extend_quarter_operand_1 (rtx op ATTRIBUTE_UNUSED, machine_mode mode ATTRIBUTE_UNUSED)
#line 1222 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  mode = GET_MODE (op);
  if (GET_MODE_CLASS (mode) != MODE_VECTOR_INT
      || GET_MODE_SIZE (mode) != 64)
...
bool
vector_all_ones_zero_extend_quarter_operand (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
  return ((GET_CODE (op) == CONST_VECTOR) && (
(vector_all_ones_zero_extend_quarter_operand_1 (op, mode)))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return (memory_operand (op, mode)) && ((
#line 1246 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(TARGET_AVX)) || (
#line 1247 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
bool
vector_or_const_vector_operand (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
  return (register_operand (op, mode)) || ((vector_memory_operand (op, mode)) || ((GET_CODE (op) == CONST_VECTOR) && (
(mode == VOIDmode || GET_MODE (op) == mode))));
}
...
#line 1263 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(TARGET_AVX512F)) && ((
#line 1264 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(TARGET_AVX512VL)) || ((
#line 1265 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(GET_MODE_SIZE (GET_MODE (op)) == 64)) && (
#line 1266 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(TARGET_EVEX512))))) && ((
#line 1267 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(VALID_BCST_MODE_P (GET_MODE_INNER (GET_MODE (op))))) && ((
#line 1268 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(GET_MODE (XEXP (op, 0))
		    == GET_MODE_INNER (GET_MODE (op)))) && (
#line 1270 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
{
  return (nonimmediate_operand (op, mode)) || ((
#line 1285 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
static inline bool
x86_64_const_vector_operand_1 (rtx op ATTRIBUTE_UNUSED, machine_mode mode ATTRIBUTE_UNUSED)
#line 1297 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  if (mode == VOIDmode)
    mode = GET_MODE (op);
...
bool
x86_64_const_vector_operand (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
  return ((GET_CODE (op) == CONST_VECTOR) && (
(x86_64_const_vector_operand_1 (op, mode)))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}

bool
nonimmediate_or_x86_64_const_vector_operand (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
  return (nonimmediate_operand (op, mode)) || (x86_64_const_vector_operand (op, mode));
}
...
{
  return (nonimmediate_operand (op, mode)) || ((
#line 1315 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
#line 1336 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
...
{
  return (
#line 1335 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
#line 1354 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
  rtx disp;
...
{
  return ((
#line 1353 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(address_operand (op, VOIDmode))) && (
...
#line 1398 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
#line 1459 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
#line 1471 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
#line 1528 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
#line 1549 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  machine_mode inmode = GET_MODE (XEXP (op, 0));
  enum rtx_code code = GET_CODE (op);
...
#line 1592 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  machine_mode inmode = GET_MODE (XEXP (op, 0));
  enum rtx_code code = GET_CODE (op);
...
#line 1608 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  machine_mode inmode = GET_MODE (XEXP (op, 0));
  enum rtx_code code = GET_CODE (op);
...
{
  return (
#line 1628 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
bool
ix86_timode_comparison_operator (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
  return (
#line 1635 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(TARGET_64BIT)) ? (ordered_comparison_operator (op, mode)) : (bt_comparison_operator (op, mode));
}

bool
ix86_timode_comparison_operand (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
  return (
#line 1641 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(TARGET_64BIT)) ? (x86_64_general_operand (op, mode)) : (nonimmediate_operand (op, mode));
}
...
#line 1685 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
bool
extract_operator (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
  switch (GET_CODE (op))
    {
    case ZERO_EXTRACT:
...
{
  return ((GET_CODE (op) == MEM) && (
#line 1697 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
#line 1703 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
...
#line 1734 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
...
#line 1758 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
#line 1764 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(XINT (XVECEXP (op, 0, 1), 1) == UNSPEC_CALLEE_ABI)) && (
#line 1765 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
...
#line 1770 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  rtx op0, op1;
  int swapped;
  HOST_WIDE_INT mask;
...
#line 1806 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  rtx op0, op1;
  bool swapped;
  int nunits, elt;
...
#line 1837 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
...
#line 1869 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
...
#line 1899 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  int perm[128];
...
#line 1929 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  int perm[128];
...
#line 1960 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  int nelt = XVECLEN (op, 0);
  int elt, i;
...
#line 1990 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
...
#line 2004 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  rtx elt = XVECEXP (op, 0, 0);
  int i, nelt = XVECLEN (op, 0);
...
#line 2020 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
...
#line 2035 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  HOST_WIDE_INT val = INTVAL (op);
...
{
  return (register_operand (op, mode)) || (((GET_CODE (op) == CONST_INT) && (
#line 2050 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
(op == constm1_rtx))) && (
(mode == VOIDmode || GET_MODE (op) == mode || GET_MODE (op) == VOIDmode)));
}
...
#line 2056 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
...
#line 2097 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  const unsigned len = XVECLEN (op, 0);
  unsigned i;
...
#line 2136 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  unsigned i;
  rtx elt;
...
#line 2180 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  unsigned i;
  rtx elt;
...
#line 2231 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
  unsigned i;
  rtx elt;
...
static inline bool
apx_ndd_memory_operand_1 (rtx op ATTRIBUTE_UNUSED, machine_mode mode ATTRIBUTE_UNUSED)
#line 2258 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
...
bool
apx_ndd_memory_operand (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
  return (memory_operand (op, mode)) && (
(apx_ndd_memory_operand_1 (op, mode)));
}

static inline bool
apx_ndd_add_memory_operand_1 (rtx op ATTRIBUTE_UNUSED, machine_mode mode ATTRIBUTE_UNUSED)
#line 2305 "../../src/gcc-14.2.0/gcc/config/i386/predicates.md"
{
...
bool
apx_ndd_add_memory_operand (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
  return (memory_operand (op, mode)) && (
(apx_ndd_add_memory_operand_1 (op, mode)));
}
...
lookup_constraint_1 (const char *str)
{
  switch (str[0])
    ...
    case 'j':
      if (str[1] == 'r')
        return CONSTRAINT_jr;
      if (str[1] == 'm')
        return CONSTRAINT_jm;
      if (str[1] == '<')
        return CONSTRAINT_j_l;
      if (str[1] == '>')
        return CONSTRAINT_j_g;
      if (str[1] == 'o')
        return CONSTRAINT_jo;
      if (str[1] == 'V')
        return CONSTRAINT_jV;
      if (str[1] == 'p')
        return CONSTRAINT_jp;
      if (str[1] == 'a')
        return CONSTRAINT_ja;
      if (str[1] == 'b')
        return CONSTRAINT_jb;
      if (str[1] == 'c')
        return CONSTRAINT_jc;
      if (str[1] == 'e')
        return CONSTRAINT_je;
      if (str[1] == 'M')
        return CONSTRAINT_jM;
      if (str[1] == 'O')
        return CONSTRAINT_jO;
...
reg_class_for_constraint_1 (enum constraint_num c)
{
  switch (c)
    ...
    case CONSTRAINT_R: return LEGACY_GENERAL_REGS;
  ...
  ? NO_REGS : GENERAL_REGS;
    ...
    case CONSTRAINT_jR: return GENERAL_REGS;
    case CONSTRAINT_jr: return TARGET_APX_EGPR ? GENERAL_GPR16 : GENERAL_REGS;
    case CONSTRAINT_jc: return TARGET_APX_EGPR && !TARGET_AVX ? GENERAL_GPR16 : GENERAL_REGS;
    default: break;
    }
  return NO_REGS;
}
...
bool (*constraint_satisfied_p_array[]) (rtx) = {
  ...
  satisfies_constraint_jm,
  satisfies_constraint_jo,
  satisfies_constraint_je,
  satisfies_constraint_jM,
  satisfies_constraint_jO,
  satisfies_constraint_Bm,
  satisfies_constraint_Bn,
  satisfies_constraint_Br,
  satisfies_constraint_ja,
  satisfies_constraint_p,
  satisfies_constraint_Tv,
  satisfies_constraint_Ts,
  satisfies_constraint_jp,
  satisfies_constraint_jb,
  ...
  satisfies_constraint_BF,
  satisfies_constraint_BM,
  satisfies_constraint_j_l,
  satisfies_constraint_j_g,
  satisfies_constraint_jV,
  satisfies_constraint_i,
