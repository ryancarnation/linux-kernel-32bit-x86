...
{
  hash_table<ctp_hasher> * const x = (hash_table<ctp_hasher> *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_mx (x);
    }
...
void
gt_ggc_mx_hash_map_const_tree_tree_ (void *x_p)
{
  hash_map<const_tree,tree> * const x = (hash_map<const_tree,tree> *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_mx (x);
    }
...
void
gt_pch_nx_hash_map_const_tree_tree_ (void *x_p)
{
  hash_map<const_tree,tree> * const x = (hash_map<const_tree,tree> *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_25hash_map_const_tree_tree_))
    {
      gt_pch_nx (x);
    }
}
...
gt_pch_p_22hash_table_ctp_hasher_ (ATTRIBUTE_UNUSED void *this_obj,
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  struct hash_table<ctp_hasher> * x ATTRIBUTE_UNUSED = (struct hash_table<ctp_hasher> *)x_p;
  if ((void *)(x) == this_obj)
    gt_pch_nx (&((*x)), op, cookie);
}
...
void
gt_pch_p_25hash_map_const_tree_tree_ (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct hash_map<const_tree,tree> * x ATTRIBUTE_UNUSED = (struct hash_map<const_tree,tree> *)x_p;
  if ((void *)(x) == this_obj)
    gt_pch_nx (&((*x)), op, cookie);
}
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gt_cp_pt_h[] = {
  ...
  },
  {
    ...
    1,
    sizeof (ctp_table),
    &gt_ggc_mx_hash_table_ctp_hasher_,
    &gt_pch_nx_hash_table_ctp_hasher_
  },
  {
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_rd_gt_cp_pt_h[] = {
  ...
  { &complex_alias_tmpl_info, 1, sizeof (complex_alias_tmpl_info), NULL, NULL },
  LAST_GGC_ROOT_TAB
};
