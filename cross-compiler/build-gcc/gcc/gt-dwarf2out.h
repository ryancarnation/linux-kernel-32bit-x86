/* Type information for dwarf2out.cc.
  ...
  if (ggc_test_and_set_mark (x))
    {
      ...
      gt_ggc_m_S ((*x).end);
      gt_ggc_m_16addr_table_entry ((*x).end_entry);
...
void
gt_ggc_mx_vec_char__va_gc_ (void *x_p)
{
  vec<char*,va_gc> * const x = (vec<char*,va_gc> *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_mx (x);
    }
...
gt_ggc_mx (struct dw_attr_struct& x_r ATTRIBUTE_UNUSED)
{
  ...
  switch ((int) (((*x).dw_attr_val).val_class))
    ...
    case dw_val_class_wide_int:
      gt_ggc_m_11dw_wide_int ((*x).dw_attr_val.v.val_wide);
      break;
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_18dw_loc_list_struct))
    {
      ...
      gt_pch_n_S ((*x).end);
      gt_pch_n_16addr_table_entry ((*x).end_entry);
...
void
gt_pch_nx_vec_char__va_gc_ (void *x_p)
{
  vec<char*,va_gc> * const x = (vec<char*,va_gc> *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_16vec_char__va_gc_))
    {
      gt_pch_nx (x);
    }
}
...
gt_pch_nx (struct dw_attr_struct& x_r ATTRIBUTE_UNUSED)
{
  ...
  switch ((int) (((*x).dw_attr_val).val_class))
    ...
    case dw_val_class_const_double:
      break;
    case dw_val_class_wide_int:
      gt_pch_n_11dw_wide_int ((*x).dw_attr_val.v.val_wide);
      break;
    case dw_val_class_vec:
      if ((*x).dw_attr_val.v.val_vec.array != NULL) {
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  switch ((int) ((*x).comdat_type_p))
    ...
    case 0:
      if ((void *)(x) == this_obj)
        op (&((*x).die_id.die_symbol), NULL, cookie);
      break;
    case 1:
      if ((void *)(x) == this_obj)
        op (&((*x).die_id.die_type_node), NULL, cookie);
      break;
    default:
      break;
    }
  if ((void *)(x) == this_obj)
    op (&((*x).die_attr), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).die_parent), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).die_child), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).die_sib), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).die_definition), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).begin), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).begin_entry), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).end), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).end_entry), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).ll_symbol), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).vl_symbol), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).section), NULL, cookie);
  if ((void *)(x) == this_obj)
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  switch ((int) (((*x)).kind))
    ...
    case 0:
      if ((void *)(x) == this_obj)
        op (&((*x).addr.rtl), NULL, cookie);
      break;
    case 1:
      if ((void *)(x) == this_obj)
        op (&((*x).addr.label), NULL, cookie);
      break;
    default:
      break;
    }
...
void
gt_pch_p_16vec_char__va_gc_ (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct vec<char*,va_gc> * x ATTRIBUTE_UNUSED = (struct vec<char*,va_gc> *)x_p;
  if ((void *)(x) == this_obj)
    gt_pch_nx (&((*x)), op, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).root_die), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).type_die), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).skeleton_die), NULL, cookie);
  if ((void *)(x) == this_obj)
...
gt_pch_nx (struct dw_attr_struct* x ATTRIBUTE_UNUSED,
	...
	ATTRIBUTE_UNUSED void *cookie)
{
    op (&((*x).dw_attr_val.val_entry), NULL, cookie);
  switch ((int) (((*x).dw_attr_val).val_class))
    {
    case dw_val_class_addr:
        op (&((*x).dw_attr_val.v.val_addr), NULL, cookie);
      break;
    case dw_val_class_offset:
      break;
    case dw_val_class_loc_list:
        op (&((*x).dw_attr_val.v.val_loc_list), NULL, cookie);
      break;
    case dw_val_class_view_list:
        op (&((*x).dw_attr_val.v.val_view_list), NULL, cookie);
      break;
    case dw_val_class_loc:
        op (&((*x).dw_attr_val.v.val_loc), NULL, cookie);
      break;
    default:
      break;
    case dw_val_class_unsigned_const:
    ...
    case dw_val_class_const_double:
      break;
    case dw_val_class_wide_int:
        op (&((*x).dw_attr_val.v.val_wide), NULL, cookie);
      break;
    case dw_val_class_vec:
      if ((*x).dw_attr_val.v.val_vec.array != NULL) {
          op (&((*x).dw_attr_val.v.val_vec.array), NULL, cookie);
      }
      break;
    case dw_val_class_die_ref:
        op (&((*x).dw_attr_val.v.val_die_ref.die), NULL, cookie);
      break;
    case dw_val_class_fde_ref:
      break;
    case dw_val_class_str:
        op (&((*x).dw_attr_val.v.val_str), NULL, cookie);
      break;
    case dw_val_class_lbl_id:
        op (&((*x).dw_attr_val.v.val_lbl_id), NULL, cookie);
      break;
    case dw_val_class_flag:
      break;
    case dw_val_class_file:
        op (&((*x).dw_attr_val.v.val_file), NULL, cookie);
      break;
    case dw_val_class_file_implicit:
        op (&((*x).dw_attr_val.v.val_file_implicit), NULL, cookie);
      break;
    case dw_val_class_data8:
      break;
    case dw_val_class_decl_ref:
        op (&((*x).dw_attr_val.v.val_decl_ref), NULL, cookie);
      break;
    case dw_val_class_vms_delta:
        op (&((*x).dw_attr_val.v.val_vms_delta.lbl1), NULL, cookie);
        op (&((*x).dw_attr_val.v.val_vms_delta.lbl2), NULL, cookie);
      break;
    case dw_val_class_discr_value:
      switch ((int) (((*x).dw_attr_val.v.val_discr_value).pos))
        {
      ...
      break;
    case dw_val_class_discr_list:
        op (&((*x).dw_attr_val.v.val_discr_list), NULL, cookie);
      break;
    case dw_val_class_symview:
        op (&((*x).dw_attr_val.v.val_symbolic_view), NULL, cookie);
      break;
    }
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).die), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).created_for), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).next), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).call_arg_loc_note), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).label), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).block), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).symbol_ref), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).next), NULL, cookie);
}
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gt_dwarf2out_h[] = {
  ...
  },
  {
    &switch_cold_ranges,
    1,
    sizeof (switch_cold_ranges),
    &gt_ggc_mx_vec_char__va_gc_,
    &gt_pch_nx_vec_char__va_gc_
  },
  {
    &switch_text_ranges,
    1,
    sizeof (switch_text_ranges),
    &gt_ggc_mx_vec_char__va_gc_,
    &gt_pch_nx_vec_char__va_gc_
  },
  {
  ...
  },
  {
    ...
    1,
    sizeof (debug_ranges_dwo_section),
    &gt_ggc_mx_section,
    &gt_pch_nx_section
  },
  {
...
EXPORTED_CONST struct ggc_root_tab gt_pch_rs_gt_dwarf2out_h[] = {
  ...
  { &in_text_section_p, 1, sizeof (in_text_section_p), NULL, NULL },
