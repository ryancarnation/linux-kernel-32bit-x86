		       ...
		       struct gcc_options *opts_set)
{
  ...
  gcc_assert (IN_RANGE (opts->x_ix86_unroll_only_small_loops, -128, 127));
  ...
  ptr->x_ix86_unroll_only_small_loops = opts->x_ix86_unroll_only_small_loops;
  ...
  if (opts_set->x_ix86_cmodel) mask |= HOST_WIDE_INT_1U << 4;
  if (opts_set->x_ix86_excess_precision) mask |= HOST_WIDE_INT_1U << 5;
  if (opts_set->x_ix86_veclibabi_type) mask |= HOST_WIDE_INT_1U << 6;
  if (opts_set->x_ix86_pmode) mask |= HOST_WIDE_INT_1U << 7;
  if (opts_set->x_ix86_incoming_stack_boundary_arg) mask |= HOST_WIDE_INT_1U << 8;
  if (opts_set->x_ix86_preferred_stack_boundary_arg) mask |= HOST_WIDE_INT_1U << 9;
  if (opts_set->x_ix86_regparm) mask |= HOST_WIDE_INT_1U << 10;
  if (opts_set->x_recip_mask) mask |= HOST_WIDE_INT_1U << 11;
  ...
  if (opts_set->x_ix86_fpmath) mask |= HOST_WIDE_INT_1U << 12;
  if (opts_set->x_ix86_move_max) mask |= HOST_WIDE_INT_1U << 13;
  if (opts_set->x_prefer_vector_width_type) mask |= HOST_WIDE_INT_1U << 14;
  if (opts_set->x_ix86_store_max) mask |= HOST_WIDE_INT_1U << 15;
  if (opts_set->x_ix86_apx_features) mask |= HOST_WIDE_INT_1U << 16;
  if (opts_set->x_flag_fentry) mask |= HOST_WIDE_INT_1U << 17;
  if (opts_set->x_ix86_needed) mask |= HOST_WIDE_INT_1U << 18;
  if (opts_set->x_ix86_unroll_only_small_loops) mask |= HOST_WIDE_INT_1U << 19;
  if (opts_set->x_ix86_stack_protector_guard_offset_str) mask |= HOST_WIDE_INT_1U << 20;
  if (opts_set->x_ix86_stack_protector_guard_reg_str) mask |= HOST_WIDE_INT_1U << 21;
  if (opts_set->x_ix86_stack_protector_guard_symbol_str) mask |= HOST_WIDE_INT_1U << 22;
  ptr->explicit_mask[0] = mask;
}
			  ...
			  struct cl_target_option *ptr)
{
  ...
  opts->x_ix86_unroll_only_small_loops = ptr->x_ix86_unroll_only_small_loops;
  ...
  mask >>= 1;
  opts_set->x_ix86_apx_features = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_flag_fentry = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_ix86_needed = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_ix86_unroll_only_small_loops = (mask & 1) != 0;
  mask >>= 1;
                        ...
                        struct cl_target_option *ptr)
{
  ...
  if (ptr->x_ix86_apx_features)
    fprintf (file, "%*s%s (%#x)\n",
             indent, "",
             "ix86_apx_features",
             ptr->x_ix86_apx_features);
  ...
  if (ptr->x_ix86_unroll_only_small_loops)
    fprintf (file, "%*s%s (%#x)\n",
             indent, "",
             "ix86_unroll_only_small_loops",
             ptr->x_ix86_unroll_only_small_loops);
                             ...
                             struct cl_target_option *ptr2 ATTRIBUTE_UNUSED)
{
  ...
  if (ptr1->x_ix86_apx_features != ptr2->x_ix86_apx_features)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent, "",
             "ix86_apx_features",
             ptr1->x_ix86_apx_features,
             ptr2->x_ix86_apx_features);
  ...
  if (ptr1->x_ix86_unroll_only_small_loops != ptr2->x_ix86_unroll_only_small_loops)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent, "",
             "ix86_unroll_only_small_loops",
             ptr1->x_ix86_unroll_only_small_loops,
             ptr2->x_ix86_unroll_only_small_loops);
  ...
  if (ptr1->x_ix86_stack_protector_guard_offset_str != ptr2->x_ix86_stack_protector_guard_offset_str
    ...
    fprintf (file, "%*s%s (%s/%s)\n",
             ...
             ptr2->x_ix86_stack_protector_guard_offset_str ? ptr2->x_ix86_stack_protector_guard_offset_str : "(null)");
  ...
  if (ptr1->x_ix86_stack_protector_guard_reg_str != ptr2->x_ix86_stack_protector_guard_reg_str
    ...
    fprintf (file, "%*s%s (%s/%s)\n",
             ...
             ptr2->x_ix86_stack_protector_guard_reg_str ? ptr2->x_ix86_stack_protector_guard_reg_str : "(null)");
  ...
  if (ptr1->x_ix86_stack_protector_guard_symbol_str != ptr2->x_ix86_stack_protector_guard_symbol_str
    ...
    fprintf (file, "%*s%s (%s/%s)\n",
             ...
             ptr2->x_ix86_stack_protector_guard_symbol_str ? ptr2->x_ix86_stack_protector_guard_symbol_str : "(null)");
                     ...
                     struct cl_target_option const *ptr2 ATTRIBUTE_UNUSED)
{
  ...
  if (ptr1->x_ix86_isa_flags_explicit != ptr2->x_ix86_isa_flags_explicit)
    return false;
  if (ptr1->x_ix86_no_avx10_1_explicit != ptr2->x_ix86_no_avx10_1_explicit)
    return false;
  if (ptr1->x_ix86_no_avx512_explicit != ptr2->x_ix86_no_avx512_explicit)
    return false;
...
cl_target_option_hash (struct cl_target_option const *ptr ATTRIBUTE_UNUSED)
{
  ...
  hstate.add_hwi (ptr->x_ix86_no_avx10_1_explicit);
  hstate.add_hwi (ptr->x_ix86_no_avx512_explicit);
  ...
  hstate.add_hwi (ptr->x_ix86_apx_features);
  ...
  hstate.add_hwi (ptr->x_ix86_unroll_only_small_loops);
                             ...
                             struct cl_target_option *ptr ATTRIBUTE_UNUSED)
{
  ...
  bp_pack_value (bp, ptr->x_ix86_no_avx10_1_explicit, 64);
  bp_pack_value (bp, ptr->x_ix86_no_avx512_explicit, 64);
  ...
  bp_pack_value (bp, ptr->x_ix86_apx_features, 64);
  ...
  bp_pack_value (bp, ptr->x_ix86_unroll_only_small_loops, 64);
  for (size_t i = 0; i < ARRAY_SIZE (ptr->explicit_mask); i++)
                            ...
                            struct cl_target_option *ptr ATTRIBUTE_UNUSED)
{
  ...
  ptr->x_ix86_no_avx10_1_explicit = (HOST_WIDE_INT) bp_unpack_value (bp, 64);
  ptr->x_ix86_no_avx512_explicit = (HOST_WIDE_INT) bp_unpack_value (bp, 64);
  ...
  ptr->x_ix86_apx_features = (int ) bp_unpack_value (bp, 64);
  ...
  ptr->x_ix86_unroll_only_small_loops = (signed char ) bp_unpack_value (bp, 64);
  for (size_t i = 0; i < ARRAY_SIZE (ptr->explicit_mask); i++)
...
cl_optimization_compare (gcc_options *ptr1, gcc_options *ptr2)
{
  ...
  if (ptr1->x_x86_stlf_window_ninsns != ptr2->x_x86_stlf_window_ninsns)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_x86_stv_max_visits != ptr2->x_x86_stv_max_visits)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_ix86_instrument_return != ptr2->x_ix86_instrument_return)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_ix86_lam_type != ptr2->x_ix86_lam_type)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_ix86_section_threshold != ptr2->x_ix86_section_threshold)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_nop_mcount != ptr2->x_flag_nop_mcount)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_ix86_noreturn_no_callee_saved_registers != ptr2->x_ix86_noreturn_no_callee_saved_registers)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_ix86_partial_vec_fp_math != ptr2->x_ix86_partial_vec_fp_math)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_prefer_vector_width_type != ptr2->x_prefer_vector_width_type)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_ix86_preferred_stack_boundary_arg != ptr2->x_ix86_preferred_stack_boundary_arg)
