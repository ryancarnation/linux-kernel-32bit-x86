  ...
  if (ggc_test_and_set_mark (x))
    {
      ...
      gt_ggc_m_S ((*x).x_ix86_stack_protector_guard_offset_str);
      gt_ggc_m_S ((*x).x_ix86_stack_protector_guard_reg_str);
      gt_ggc_m_S ((*x).x_ix86_stack_protector_guard_symbol_str);
    }
}
...
gt_pch_nx_cl_target_option (void *x_p)
{
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_16cl_target_option))
    {
      gt_pch_n_S ((*x).x_ix86_arch_string);
      gt_pch_n_S ((*x).x_ix86_recip_name);
      gt_pch_n_S ((*x).x_ix86_tune_ctrl_string);
      gt_pch_n_S ((*x).x_ix86_tune_memcpy_strategy);
      gt_pch_n_S ((*x).x_ix86_tune_memset_strategy);
      gt_pch_n_S ((*x).x_ix86_tune_string);
      gt_pch_n_S ((*x).x_ix86_stack_protector_guard_offset_str);
      gt_pch_n_S ((*x).x_ix86_stack_protector_guard_reg_str);
      gt_pch_n_S ((*x).x_ix86_stack_protector_guard_symbol_str);
    }
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).x_ix86_arch_string), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).x_ix86_recip_name), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).x_ix86_tune_ctrl_string), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).x_ix86_tune_memcpy_strategy), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).x_ix86_tune_memset_strategy), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).x_ix86_tune_string), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).x_ix86_stack_protector_guard_offset_str), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).x_ix86_stack_protector_guard_reg_str), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).x_ix86_stack_protector_guard_symbol_str), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).stack_locals), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).split_stack_varargs_pointer), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).fs.cfa_reg), NULL, cookie);
}
