  ...
  while (x != xlimit)
    {
      switch ((int) (cp_tree_node_structure (&((*x)))))
        ...
        case TS_CP_LAMBDA_EXPR:
          ...
          gt_ggc_m_9tree_node ((*x).lambda_expression.extra_args);
        ...
        case TS_CP_TEMPLATE_INFO:
          ...
          gt_ggc_m_9tree_node ((*x).template_info.partial);
  ...
  while (x != xlimit)
    {
      switch ((int) (cp_tree_node_structure (&((*x)))))
        ...
        case TS_CP_LAMBDA_EXPR:
          ...
          gt_pch_n_9tree_node ((*x).lambda_expression.extra_args);
        ...
        case TS_CP_TEMPLATE_INFO:
          ...
          gt_pch_n_9tree_node ((*x).template_info.partial);
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  switch ((int) (cp_tree_node_structure (&((*x)))))
    ...
    case TS_CP_LAMBDA_EXPR:
      ...
      if ((void *)(x) == this_obj)
        op (&((*x).lambda_expression.extra_args), NULL, cookie);
      if ((void *)(x) == this_obj)
    ...
    case TS_CP_TEMPLATE_INFO:
      ...
      if ((void *)(x) == this_obj)
        op (&((*x).template_info.partial), NULL, cookie);
      if ((void *)(x) == this_obj)
