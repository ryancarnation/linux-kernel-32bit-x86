...
gt_ggc_mx (struct omp_declare_variant_entry& x_r ATTRIBUTE_UNUSED)
{
  ...
  gt_ggc_mx (&((*x).score));
  gt_ggc_mx (&((*x).score_in_declare_simd_clone));
...
gt_pch_nx (struct omp_declare_variant_entry& x_r ATTRIBUTE_UNUSED)
{
  ...
  gt_pch_nx (&((*x).score));
  gt_pch_nx (&((*x).score_in_declare_simd_clone));
	...
	ATTRIBUTE_UNUSED void *cookie)
{
    ...
    gt_pch_nx (&((*x).score), op, cookie);
    gt_pch_nx (&((*x).score_in_declare_simd_clone), op, cookie);
