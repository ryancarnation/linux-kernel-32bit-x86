...
gt_ggc_mx_lang_tree_node (void *x_p)
{
  ...
  while (x != xlimit)
    {
      switch ((int) (TREE_CODE (&((*x)).generic) == IDENTIFIER_NODE + 2 * (TREE_CODE (&((*x)).generic) == C_TOKEN_VEC)))
        {
        case 0:
        ...
        case 1:
          ...
          break;
        case 2:
          gt_ggc_m_18vec_c_token_va_gc_ ((*x).c_token_vec.tokens);
          break;
        default:
          break;
        }
...
void
gt_ggc_mx_hash_table_c_struct_hasher_ (void *x_p)
{
  hash_table<c_struct_hasher> * const x = (hash_table<c_struct_hasher> *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_mx (x);
    }
...
void
gt_ggc_mx (struct c_struct_hasher& x_r ATTRIBUTE_UNUSED)
{
  struct c_struct_hasher * ATTRIBUTE_UNUSED x = &x_r;
}
...
void
gt_ggc_mx_vec_c_omp_declare_target_attr_va_gc_ (void *x_p)
{
  vec<c_omp_declare_target_attr,va_gc> * const x = (vec<c_omp_declare_target_attr,va_gc> *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_mx (x);
    }
...
void
gt_ggc_mx (struct c_omp_declare_target_attr& x_r ATTRIBUTE_UNUSED)
{
  struct c_omp_declare_target_attr * ATTRIBUTE_UNUSED x = &x_r;
}

void
gt_ggc_mx_vec_c_omp_begin_assumes_data_va_gc_ (void *x_p)
{
  vec<c_omp_begin_assumes_data,va_gc> * const x = (vec<c_omp_begin_assumes_data,va_gc> *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_mx (x);
    }
...
void
gt_ggc_mx (struct c_omp_begin_assumes_data& x_r ATTRIBUTE_UNUSED)
{
  struct c_omp_begin_assumes_data * ATTRIBUTE_UNUSED x = &x_r;
}
  ...
  while (x != xlimit)
    {
      switch ((int) (TREE_CODE (&((*x)).generic) == IDENTIFIER_NODE + 2 * (TREE_CODE (&((*x)).generic) == C_TOKEN_VEC)))
        ...
        case 1:
          ...
          gt_pch_n_S2 ((*x).identifier.common_id.node.ident.str, 1 + ((*x).identifier.common_id.node.ident).len);
          switch ((int) (((*x).identifier.common_id.node).type))
            {
            case NT_VOID:
          ...
          break;
        case 2:
          gt_pch_n_18vec_c_token_va_gc_ ((*x).c_token_vec.tokens);
          break;
        default:
          break;
        }
...
void
gt_pch_nx_hash_table_c_struct_hasher_ (void *x_p)
{
  hash_table<c_struct_hasher> * const x = (hash_table<c_struct_hasher> *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_27hash_table_c_struct_hasher_))
    {
      gt_pch_nx (x);
    }
}
...
void
gt_pch_nx (struct c_struct_hasher& x_r ATTRIBUTE_UNUSED)
{
  struct c_struct_hasher * ATTRIBUTE_UNUSED x = &x_r;
}
...
void
gt_pch_nx_vec_c_omp_declare_target_attr_va_gc_ (void *x_p)
{
  vec<c_omp_declare_target_attr,va_gc> * const x = (vec<c_omp_declare_target_attr,va_gc> *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_36vec_c_omp_declare_target_attr_va_gc_))
    {
      gt_pch_nx (x);
    }
}
...
void
gt_pch_nx (struct c_omp_declare_target_attr& x_r ATTRIBUTE_UNUSED)
{
  struct c_omp_declare_target_attr * ATTRIBUTE_UNUSED x = &x_r;
}

void
gt_pch_nx_vec_c_omp_begin_assumes_data_va_gc_ (void *x_p)
{
  vec<c_omp_begin_assumes_data,va_gc> * const x = (vec<c_omp_begin_assumes_data,va_gc> *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_35vec_c_omp_begin_assumes_data_va_gc_))
    {
      gt_pch_nx (x);
    }
}
...
void
gt_pch_nx (struct c_omp_begin_assumes_data& x_r ATTRIBUTE_UNUSED)
{
  struct c_omp_begin_assumes_data * ATTRIBUTE_UNUSED x = &x_r;
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  switch ((int) (TREE_CODE (&((*x)).generic) == IDENTIFIER_NODE + 2 * (TREE_CODE (&((*x)).generic) == C_TOKEN_VEC)))
    ...
    case 2:
      if ((void *)(x) == this_obj)
        op (&((*x).c_token_vec.tokens), NULL, cookie);
      break;
    default:
      break;
    }
...
void
gt_pch_p_27hash_table_c_struct_hasher_ (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct hash_table<c_struct_hasher> * x ATTRIBUTE_UNUSED = (struct hash_table<c_struct_hasher> *)x_p;
  if ((void *)(x) == this_obj)
    gt_pch_nx (&((*x)), op, cookie);
}

void
gt_pch_nx (struct c_struct_hasher* x ATTRIBUTE_UNUSED,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
}
...
void
gt_pch_p_36vec_c_omp_declare_target_attr_va_gc_ (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct vec<c_omp_declare_target_attr,va_gc> * x ATTRIBUTE_UNUSED = (struct vec<c_omp_declare_target_attr,va_gc> *)x_p;
  if ((void *)(x) == this_obj)
    gt_pch_nx (&((*x)), op, cookie);
}

void
gt_pch_nx (struct c_omp_declare_target_attr* x ATTRIBUTE_UNUSED,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
}
...
void
gt_pch_p_35vec_c_omp_begin_assumes_data_va_gc_ (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct vec<c_omp_begin_assumes_data,va_gc> * x ATTRIBUTE_UNUSED = (struct vec<c_omp_begin_assumes_data,va_gc> *)x_p;
  if ((void *)(x) == this_obj)
    gt_pch_nx (&((*x)), op, cookie);
}

void
gt_pch_nx (struct c_omp_begin_assumes_data* x ATTRIBUTE_UNUSED,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
}
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gt_c_c_decl_h[] = {
  {
    ...
    1,
    sizeof (current_omp_begin_assumes),
    &gt_ggc_mx_vec_c_omp_begin_assumes_data_va_gc_,
    &gt_pch_nx_vec_c_omp_begin_assumes_data_va_gc_
  },
  {
    &current_omp_declare_target_attribute,
    1,
    sizeof (current_omp_declare_target_attribute),
    &gt_ggc_mx_vec_c_omp_declare_target_attr_va_gc_,
    &gt_pch_nx_vec_c_omp_declare_target_attr_va_gc_
  },
  {
    &ext_block,
    1,
  ...
  },
  {
    &c_struct_htab,
    1,
    sizeof (c_struct_htab),
    &gt_ggc_mx_hash_table_c_struct_hasher_,
    &gt_pch_nx_hash_table_c_struct_hasher_
  },
  {
    &c_inline_statics,
    1,
