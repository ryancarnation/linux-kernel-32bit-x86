/* Type information for varasm.cc.
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).mem), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).sym), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).constant), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).const_rtx_htab), NULL, cookie);
}
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gt_varasm_h[] = {
  ...
  },
  {
    ...
    1,
    sizeof (pending_libcall_symbols),
    &gt_ggc_mx_rtx_def,
    &gt_pch_nx_rtx_def
  },
  {
