/* Type information for cp/parser.cc.
...
gt_ggc_mx (struct cp_unparsed_functions_entry& x_r ATTRIBUTE_UNUSED)
{
  ...
  gt_ggc_m_15vec_tree_va_gc_ ((*x).contracts);
}
...
gt_pch_nx (struct cp_unparsed_functions_entry& x_r ATTRIBUTE_UNUSED)
{
  ...
  gt_pch_n_15vec_tree_va_gc_ ((*x).contracts);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).qualifying_scope), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  switch ((int) (((*x)).tree_check_p))
    {
    case true:
        op (&((*x).u.tree_check_value), NULL, cookie);
      break;
    case false:
        op (&((*x).u.value), NULL, cookie);
      break;
    default:
      break;
    }
...
gt_pch_nx (struct cp_unparsed_functions_entry* x ATTRIBUTE_UNUSED,
	...
	ATTRIBUTE_UNUSED void *cookie)
{
    op (&((*x).funs_with_default_args), NULL, cookie);
    op (&((*x).funs_with_definitions), NULL, cookie);
    op (&((*x).nsdmis), NULL, cookie);
    op (&((*x).noexcepts), NULL, cookie);
    op (&((*x).contracts), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).lexer), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).scope), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).object_scope), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).qualifying_scope), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).context), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).type_definition_forbidden_message), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).type_definition_forbidden_message_arg), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).unparsed_queues), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).implicit_template_parms), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).implicit_template_scope), NULL, cookie);
}
